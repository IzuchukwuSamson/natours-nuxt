  ...
  <div>
    <header class="header">
      <nav class="nav nav--tours">
        ...
        <nuxt-link to="overview" class="nav__el">Overview</nuxt-link>
        ...
        <div class="card">
          <div class="card__header">
            <div class="card__picture">
              <div class="card__picture-overlay">&nbsp;</div>
              <img
                src="/assets/img/tours/tour-3-cover.jpg"
                alt="Tour 1"
                class="card__picture-img"
              />
            </div>
        ...
        <div class="card">
          <div class="card__header">
            <div class="card__picture">
              <div class="card__picture-overlay">&nbsp;</div>
              <img
                src="/assets/img/tours/tour-4-cover.jpg"
                alt="Tour 1"
                class="card__picture-img"
              />
            </div>
        ...
        <div class="card">
          <div class="card__header">
            <div class="card__picture">
              <div class="card__picture-overlay">&nbsp;</div>
              <img
                src="/assets/img/tours/tour-5-cover.jpg"
                alt="Tour 1"
                class="card__picture-img"
              />
            </div>
        ...
        <div class="card">
          <div class="card__header">
            <div class="card__picture">
              <div class="card__picture-overlay">&nbsp;</div>
              <img
                src="/assets/img/tours/tour-6-cover.jpg"
                alt="Tour 1"
                class="card__picture-img"
              />
            </div>
